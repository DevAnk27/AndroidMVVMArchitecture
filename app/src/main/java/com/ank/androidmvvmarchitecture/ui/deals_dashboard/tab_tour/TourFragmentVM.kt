 ...
 */
class TourFragmentVM @Inject constructor(var context: Application) : ViewModel() {
    ...
    private fun loadDeals() {
        ...
        val type = arrayOf(context.resources.getString(R.string.tab_tour), context.resources.getString(R.string.tab_tour), context.resources.getString(R.string.tab_tour),
                context.resources.getString(R.string.tab_tour), context.resources.getString(R.string.tab_tour), context.resources.getString(R.string.tab_tour),
                context.resources.getString(R.string.tab_tour), context.resources.getString(R.string.tab_tour), context.resources.getString(R.string.tab_tour),
                context.resources.getString(R.string.tab_tour), context.resources.getString(R.string.tab_tour), context.resources.getString(R.string.tab_tour),
                context.resources.getString(R.string.tab_tour), context.resources.getString(R.string.tab_tour), context.resources.getString(R.string.tab_tour))
